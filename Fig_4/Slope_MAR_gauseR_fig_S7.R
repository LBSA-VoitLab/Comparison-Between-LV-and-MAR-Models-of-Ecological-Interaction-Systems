...
# tiff("FigS7a.tiff", height = 7.5, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(1,1))		#,mar=c(5, 6, 4, 2) + 0.1
...
# tiff("FigS7b.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
...
# tiff("FigS7c.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,1))		# ,mar=c(5, 6, 4, 2) + 0.1
...
# tiff("FigS7d1.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,1))		#,mar=c(5, 6, 4, 2) + 0.1   
...
# tiff("FigS7d2.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,1))		#,mar=c(5, 6, 4, 2) + 0.1   
...
# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("FigS7e.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,1))		#,mar=c(5, 6, 4, 2) + 0.1   \n
