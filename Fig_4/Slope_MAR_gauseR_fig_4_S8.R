...
# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("Fig4a.tiff", height = 7.5, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(1,1))		#,mar=c(5, 6, 4, 2) + 0.1
...
# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("Fig4b.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
...
# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("Fig4c.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,1))		# ,mar=c(5, 6, 4, 2) + 0.1
main_lab = c( expression(paste(italic('P. caudatum'), " (Prey)")),expression(paste(italic('D. nasutum'), " (Predator)")) )
for (v in 2:3)
	{
...
# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("Fig4d1.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,1))		#,mar=c(5, 6, 4, 2) + 0.1   
...
# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("Fig4e.tiff", height = 15, width = 7.5, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,1))		#,mar=c(5, 6, 4, 2) + 0.1   \n
...
# setwd("C:\\Users\\doliv\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("FigS8.tiff", height = 15, width = 15, units = 'cm',compression = "lzw", res = 300)
par(mfrow=c(2,2))		#,mar=c(5, 6, 4, 2) + 0.1   \n
