...
# setwd("C:\\Users\\dolivenca3\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # gatech
# tiff("fig5a.tiff", height = 15, width = 15, units = 'cm',compression = "lzw", res = 300)
...
# setwd("C:\\Users\\dolivenca3\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
...
# isleRoyal = read.csv('C:\\Users\\dolivenca3\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\paper_scripts\\Fig_5\\Holme_isle_royale_data\\isleRoyale.csv')
isleRoyal = read.csv('C:\\Users\\dolivenca3\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\paper_scripts\\Fig_5\\Holme_isle_royale_data\\isleRoyale.csv')
...
# setwd("C:\\Users\\dolivenca3\\OneDrive\\2_2019_America\\2020\\20200123_MAR\\Camparison_LV_MAR\\11_Frontiers\\V3\\Figures")     # P51
# tiff("fig5b.tiff", height = 30, width = 15, units = 'cm',compression = "lzw", res = 300)
...
for (i in 2:3)
	...
	points(1960+0:(dim(MARvalEst1)[1]-1),exp(MARvalEst1[,i-1]*royale_stats[2,i-1]+royale_stats[1,i-1]),type='l',col='green',lwd=3)
	points(1960+0:(dim(MARvalEst1)[1]-1),exp(MARvalEst1[,i-1]*royale_stats[2,i-1]+royale_stats[1,i-1]-2*sqrt(MARparEst1[i-1,4])),type='l',col='green',lty=2,lwd=2)
	points(1960+0:(dim(MARvalEst1)[1]-1),exp(MARvalEst1[,i-1]*royale_stats[2,i-1]+royale_stats[1,i-1]+2*sqrt(MARparEst1[i-1,4])),type='l',col='green',lty=2,lwd=2)
	...
	if (i==3) { legend(1960,3000,legend=c('data','ALVI-MI method','MAR log transformation'),lty=c(NA,1,1),lwd=c(1,3,3),pch=c(1,NA,NA),col=c('black','blue','green'),bty = "n",cex=1) }
	}
