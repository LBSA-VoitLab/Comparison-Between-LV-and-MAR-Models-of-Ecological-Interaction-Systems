...
legend(.6,1.3,legend = c('data','Mühlbauer est','ALVI-MI method','MAR no transform','MAR log transform','MAR no transform with smoothing','MAR log transform with smoothing'),lty = c(NA,1,1,1,1,1,1),lwd=c(NA,3,3,3,3,3,3),pch = c(1,NA,NA,NA,NA,NA,NA),col = c(colorPallet,'orange','khaki'),bty = "n",cex=.5) # ,
# dev.off()
